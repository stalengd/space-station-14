...
corvax-hidden-desc-IllegalImplants-medical = [color=#52B4E9]Сверив серийные номера, вы понимаете, что это несертифицированный имплант внутри.[/color]
corvax-hidden-desc-LegalImplants-medical = [color=#52B4E9]Сверив серийные номера, вы понимаете, что это легальный, сертифицированный имплант внутри.[/color]
...
corvax-hidden-desc-DeathAcidifierImplanter-research = [color=#D381C9]Внутри имплант посмертного растворителя. Растворяет носителя и всё снаряжение при его смерти.[/color]
corvax-hidden-desc-DeathRattleImplanter-research = [color=#D381C9]Внутри имплант предсмертного хрипа. Сообщает в неизвестный радиоканал о жизненных показателях носителя.[/color]
corvax-hidden-desc-FakeMindShieldImplant-research = [color=#D381C9]Внутри имплант фальшивой защиты разума. Носитель может отображаться как существо с защитой разума.[/color]
corvax-hidden-desc-RadioImplant-research = [color=#D381C9]Внутри имплант позволяющий использовать радиоканал без наушника. Шифровальный ключ внутри не соответствует каналам НаноТрейзен.[/color]
...
corvax-hidden-desc-DeathAcidifierImplanter-syndicate = [color=#e31735]Внутри имплант посмертного растворителя. Уничтожит тело и все улики при смерти.[/color]
corvax-hidden-desc-DeathRattleImplanter-syndicate = [color=#e31735]Внутри имплант предсмертного хрипа. Сообщит в радиоканал Синдиката, если носитель окажется в критическом состоянии или погибнет.[/color]
