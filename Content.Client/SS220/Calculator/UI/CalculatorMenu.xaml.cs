...
public sealed partial class CalculatorMenu : BaseWindow
{
    ...
    public CalculatorMenu(CalculatorBoundUserInterface owner) : this()
    {
        ...
        _buttons.Add(ButtonDigit0);
        _buttons.Add(ButtonDigit1);
        _buttons.Add(ButtonDigit2);
        _buttons.Add(ButtonDigit3);
        _buttons.Add(ButtonDigit4);
        _buttons.Add(ButtonDigit5);
        _buttons.Add(ButtonDigit6);
        _buttons.Add(ButtonDigit7);
        _buttons.Add(ButtonDigit8);
        _buttons.Add(ButtonDigit9);
        _buttons.Add(ButtonDot);
        _buttons.Add(ButtonPlus);
        _buttons.Add(ButtonMinus);
        _buttons.Add(ButtonMultiply);
        _buttons.Add(ButtonDivide);
        _buttons.Add(ButtonClear);
        _buttons.Add(ButtonClearEntry);
        _buttons.Add(ButtonEquals);
        _buttons.Add(ButtonClose);

        foreach (var button in _buttons)
        {
            button.OnPressed += _ => owner.OnButtonPressed();
        }
