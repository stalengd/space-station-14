...
Ссылки на изображения записанные в формате "![{имя}]({ссылка})" будут добавлены в список изменений на дискорд сервере (не более 10!).
Если ссылка не должна добавляться в список изменений - добавьте "!" перед именем ссылки (Пример: "![!{имя}]({ссылка})"). -->
